...
/**
 * {@link Comparator} for {@link Track}s
 */

public class TrackNameComporatorGeneralisedMaximumOfContainment implements Comparator<Album, Attribute> {
	...
	GeneralisedMaximumOfContainment generalizedMaxOfContainmentSimilarity = new GeneralisedMaximumOfContainment(levenshteinSimilarity, 0.7);
