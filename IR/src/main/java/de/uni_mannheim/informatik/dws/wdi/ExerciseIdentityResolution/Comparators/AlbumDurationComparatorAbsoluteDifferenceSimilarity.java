 ...
 * {@link Album#getDuration()} values, and their
 ...
 * 
 */
public class AlbumDurationComparatorAbsoluteDifferenceSimilarity implements Comparator<Album, Attribute> {
...
//	TokenizingJaccardSimilarity sim = new TokenizingJaccardSimilarity();
	...
	public double compare(
		...
		Double n1 = (double) record1.getDuration();
		Double n2 = (double) record2.getDuration();
