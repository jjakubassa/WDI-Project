...
////		List<Artist> artists = getObjectListFromChildElement(node, "Artists",
////				"ArtistName", new ArtistXMLReader(), provenanceInfo);
////		
...
//			List<String> strList = new ArrayList<String>(Arrays.asList(replace1.split(",")));
//			
//			Artist artist = new Artist(name, provenanceInfo);
//
//			// fill the attributes
//			artist.setName(getValueFromChildElement(node, "name"));
//			List<Artist> artistList = strList.stream().map(a -> new Artist(stripQuotes(a))).collect(Collectors.toList());
//		
//			Album.setArtists(artistList);
//		}
