...
import de.uni_mannheim.informatik.dws.winter.datafusion.conflictresolution.string.LongestStringExplicitRemoval;
 ...
 * 
 */
public class TitleFuserLongestStringRemoveExplicit extends
		AttributeValueFuser<String, Album, Attribute> {

	public TitleFuserLongestStringRemoveExplicit() {
		super(new LongestStringExplicitRemoval<Album, Attribute>());
	}
	...
	public void fuse(RecordGroup<Album, Attribute> group, Album fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Album.TITLE,
