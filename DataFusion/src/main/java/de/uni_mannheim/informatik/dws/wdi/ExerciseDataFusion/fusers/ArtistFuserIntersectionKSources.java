 ...
 * 
 */
public class ArtistFuserIntersectionKSources extends
	 ...
	 */
	public ArtistFuserIntersectionKSources(int k) {
		super(new IntersectionKSources<Artist, Album, Attribute>(k));
	}
